<?php $this->beginContent('/layouts/main'); ?>
    ...
    <div class="submenu">
        <ul>
            <li><?php echo CHtml::link('Терминалы', array('dealer/index')) ?></li>
            <li><a href="<?php echo $this->createUrl('dealer/showtransfers'); ?>">История денежных переводов</a></li>
            <li><?php echo CHtml::link('Транзакции', array('transaction/index')) ?></li>
            <li><?php echo CHtml::link('Изменить пароль', array('dealer/changepassword')) ?></li>
        </ul>
    </div>

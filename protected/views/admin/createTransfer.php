...
<div class="form">
    ...
    <div class="row">
        <label>Кому</label>
        <span style="line-height: 32px">Дистрибютор <b><?php echo $model->receiver->username . " (" . $model->receiver->organization . ")" ?></b></span>
    </div>
    <div class="row">
        <?php echo CHtml::activeLabelEx($model->receiver, "reminder"); ?>
        <?php echo CHtml::activeTextField($model->receiver, "reminder", array("disabled" => "disabled", 'id' => 'reminder')); ?>
    </div>

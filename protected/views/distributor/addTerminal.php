<?php $this->pageTitle = Yii::app()->name . ' - Новый терминал'; ?>

<h3>Добавление нового терминала</h3>
...
<div class="form">
    ...
    <fieldset title="Основные данные">
        <div class="row">
            <?php echo CHtml::label('Диллер', ''); ?>
            <span style="line-height: 32px"><b><?php echo $dealer->username . ' (' . $dealer->organization . ')' ?></b></span>
        </div>
